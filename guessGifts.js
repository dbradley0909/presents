...
let wantedGifts = [
{name: "yellow car", size: "large", clatters: "no", weight: "heavy"},
{name: "diamond watch", size: "medium", clatters: "no", weight: "light"},
{name: "bracelet", size: "medium", clatters: "a bit", weight: "medium"},]

const Mywishlist = wantedGifts.filter(({ weight }) => weight).map(({ name }) => name);
